...
round2 = Round.create(deck_id: deck2.id, user_id: user2.id)
round3 = Round.create(deck_id: deck3.id, user_id: user3.id)
...
Answer.create(question_id: question6.id, answers: 'Mad Men', value_answer: true)
Answer.create(question_id: question6.id, answers: 'Shameless', value_answer: false)
Answer.create(question_id: question6.id, answers: 'Juego de Tronos', value_answer: false)
...
Answer.create(question_id: question12.id, answers: 'De Información y Turismo', value_answer: true)
...
Answer.create(question_id: question13.id, answer: '1', value_answer: true)
